...
package project.listick.fake.Services;
...
import project.listick.fake.ListickApp;
import project.listick.fake.LocationOperations;
import project.listick.fake.MainServiceControl;
import project.listick.fake.MockLocProvider;
import project.listick.fake.PermissionManager;

public class FixedSpooferService extends Service {


    /**
     *  its really important class
     */

    /**
     *  this is service for mock location
     *  and spoofing location
     */
